...
const MART_DATASET_ID = process.env.BQ_MART_DATASET ?? DATASET_ID
const LOCATION = process.env.BQ_LOCATION ?? 'US'
const SOURCE_TABLE = process.env.BQ_SOURCE_TABLE ?? process.env.BQ_DATASET_VIEW ?? 'indicadores_curados_snapshot'
