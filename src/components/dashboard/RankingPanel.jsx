...
const monetaryRankingMetrics = [
  ...
  { id: 'vr_contraprestacoes', label: '311 – Contraprestações', format: 'currency', trend: 'higher' },
  { id: 'vr_contraprestacoes_efetivas', label: '3111 – Contraprestações efetivas', format: 'currency', trend: 'higher' },
  { id: 'vr_contraprestacoes_pre', label: '311121 – Contraprestações (pré)', format: 'currency', trend: 'higher' },
  { id: 'vr_eventos_liquidos', label: '41 – Eventos líquidos', format: 'currency', trend: 'lower' },
  { id: 'vr_eventos_a_liquidar', label: '2111 – Eventos a liquidar', format: 'currency', trend: 'lower' },
  { id: 'vr_corresponsabilidade_cedida', label: '3117 – Corresponsabilidade cedida', format: 'currency', trend: 'lower' },
  { id: 'vr_desp_comerciais', label: '43 – Despesas comerciais', format: 'currency', trend: 'lower' },
  { id: 'vr_desp_comerciais_promocoes', label: '464119113 – Promoções', format: 'currency', trend: 'lower' },
  { id: 'vr_desp_administrativas', label: '46 – Despesas administrativas', format: 'currency', trend: 'lower' },
  { id: 'vr_outras_desp_oper', label: '44 – Outras despesas operacionais', format: 'currency', trend: 'lower' },
  { id: 'vr_desp_tributos', label: '47 – Despesas tributárias', format: 'currency', trend: 'lower' },
  { id: 'vr_outras_receitas_operacionais', label: '33 – Outras receitas operacionais', format: 'currency', trend: 'higher' },
  { id: 'vr_receitas_fin', label: '35 – Receitas financeiras', format: 'currency', trend: 'higher' },
  { id: 'vr_despesas_fin', label: '45 – Despesas financeiras', format: 'currency', trend: 'lower' },
  { id: 'vr_receitas_patrimoniais', label: '36 – Receitas patrimoniais', format: 'currency', trend: 'higher' },
  { id: 'vr_creditos_operacoes_saude', label: '1231 – Créditos (op. saúde)', format: 'currency', trend: 'higher' },
